...
<b>Figure 1</b>: This illustration above shows the different parameters, in addition to the number of rows and columns, that need to be passed in when calibrating the slate with some of your text with full braille cells at the corners. In my case for example, I needed to pass in the following arguments when calibrating the code:
```
python3 brl-slate-reader.py "top_left_x_pixel:351" "top_left_y_pixel:2347" "horizontal_pixels:2603" "vertical_pixels:1530" "slate_cols:36" "slate_rows:13"
```
